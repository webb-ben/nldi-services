...
public class NavigationTest {
	...
	protected Map<String, String> goodResult() {
		...
		navigationResult.put(NavigationDao.NAVIGATE, "(13297246,0.0000000000,,,0,,{4d06cca2-001e-11e6-b9d0-0242ac110003})");
		return navigationResult;
	}

	protected Map<String, String> badResult1() {
		Map<String,String> navigationResult = new LinkedHashMap<>();
		navigationResult.put(NavigationDao.NAVIGATE, "(,,,,-1,\"Valid navigation type codes are UM, UT, DM, DD and PP.\",)");
		return navigationResult;
	}

	protected Map<String, String> badResult2() {
		Map<String,String> navigationResult = new LinkedHashMap<>();
		navigationResult.put(NavigationDao.NAVIGATE, "13297246,1.1545800000,13297198,48.5846800000,310,\"Start ComID must have a hydroseq greater than the hydroseq for stop ComID.\",{f170f490-00ad-11e6-8f62-0242ac110003})");
		return navigationResult;
	}

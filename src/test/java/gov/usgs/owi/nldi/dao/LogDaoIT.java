...
public class LogDaoIT extends BaseIT {
  ...
  public static final String TEST_QUERY =
      "select web_service_log_id, to_char(request_timestamp_utc, 'YYYY-MM-DD HH24:MI')"
          + " request_timestamp_utc, to_char(request_completed_utc, 'YYYY-MM-DD HH24:MI')"
          + " request_completed_utc, referer, user_agent, request_uri, query_string from"
          + " nldi_data.web_service_log";

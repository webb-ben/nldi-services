...
public class LegacyCountDaoTest extends BaseSpringTest {
	...
	public void countFlowLinesTest() {
		...
		assertNotNull(countDao.count(BaseDao.FLOW_LINES_LEGACY, parameterMap));
	}
	...
	public void countFeaturesTest() {
		...
		assertNotNull(countDao.count(BaseDao.FEATURES_LEGACY, parameterMap));
	}

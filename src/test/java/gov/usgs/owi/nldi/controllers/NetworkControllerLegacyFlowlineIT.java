...
public class NetworkControllerLegacyFlowlineIT extends BaseIT {
	...
	public void getComidUtTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13293474/navigate/UT?legacy=true"))
	...
	public void getComidUtDistanceTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13297246/navigate/UT?distance=10&legacy=true"))
				.andExpect(status().isOk())
	...
	public void getComidUmTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13293474/navigate/UM?legacy=true"))
				.andExpect(status().isOk())
	...
	public void getComidUmDistanceTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13297246/navigate/UM?distance=10&legacy=true"))
				.andExpect(status().isOk())
	...
	public void getComidDmTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13296790/navigate/DM?legacy=true"))
				.andExpect(status().isOk())
	...
	public void getComidDmDiversionsNotIncludedTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13294310/navigate/DM?legacy=true"))
				.andExpect(status().isOk())
				.andExpect(header().string(FlowLineTransformer.FLOW_LINES_COUNT_HEADER, "5"))
				.andExpect(header().string(NetworkController.HEADER_CONTENT_TYPE, NetworkController.MIME_TYPE_GEOJSON))
				.andReturn();
	...
	public void getComidDmDistanceTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13293474/navigate/DM?distance=10&legacy=true"))
				.andExpect(status().isOk())
	...
	public void getComidDdTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13294310/navigate/DD?legacy=true"))
				.andExpect(status().isOk())
	...
	public void getComidDdDistanceTest() throws Exception {
		...
		MvcResult rtn = mockMvc.perform(get("/api/comid/13294310/navigate/DD?distance=11&legacy=true"))
				.andExpect(status().isOk())
	...
	public void getComidPpStopComidInvalidTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13297246/navigate/PP?stopComid=13297198&legacy=true"))
	...
	public void getComidPpStopComidTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13297198/navigate/PP?stopComid=13297246&legacy=true"))
				.andExpect(status().isOk())
	...
	public void interestingTest() throws Exception {
		MvcResult rtn = mockMvc.perform(get("/api/comid/13293844/navigate/DM?distance=5&legacy=true"))
				.andExpect(status().isOk())
				.andExpect(header().string(FlowLineTransformer.FLOW_LINES_COUNT_HEADER, "7"))
				.andExpect(header().string(NetworkController.HEADER_CONTENT_TYPE, NetworkController.MIME_TYPE_GEOJSON))
				.andReturn();
		...
		rtn = mockMvc.perform(get("/api/comid/13293844/navigate/DD?distance=5&legacy=true"))
				.andExpect(status().isOk())
		...
		rtn = mockMvc.perform(get("/api/comid/13294328/navigate/DM?distance=5&legacy=true"))
				.andExpect(status().isOk())
				.andExpect(header().string(FlowLineTransformer.FLOW_LINES_COUNT_HEADER, "6"))
				.andExpect(header().string(NetworkController.HEADER_CONTENT_TYPE, NetworkController.MIME_TYPE_GEOJSON))
				.andReturn();
		...
		rtn = mockMvc.perform(get("/api/comid/13294328/navigate/DD?distance=5&legacy=true"))
				.andExpect(status().isOk())
		...
		rtn = mockMvc.perform(get("/api/comid/13294390/navigate/UM?distance=5&legacy=true"))
				.andExpect(status().isOk())
				.andExpect(header().string(FlowLineTransformer.FLOW_LINES_COUNT_HEADER, "6"))
				.andExpect(header().string(NetworkController.HEADER_CONTENT_TYPE, NetworkController.MIME_TYPE_GEOJSON))
				.andReturn();
		...
		rtn = mockMvc.perform(get("/api/comid/13294390/navigate/UT?distance=5&legacy=true"))
				.andExpect(status().isOk())

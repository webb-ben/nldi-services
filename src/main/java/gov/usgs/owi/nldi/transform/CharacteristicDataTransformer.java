...
public class CharacteristicDataTransformer extends OutputStream implements ITransformer {
	private static final Logger LOG = LoggerFactory.getLogger(CharacteristicDataTransformer.class);

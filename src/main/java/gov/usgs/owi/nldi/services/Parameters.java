...
public class Parameters {
  ...
  public static final String DISTANCE_DESCRIPTION_NEW =
      "Distance in kilometers. Note that this is a very expensive query and should not be executed"
          + " in parallel";
  ...
  public static final String COORDS_DESCRIPTION =
      "coordinates in the form 'POINT(longitude latitude)'";
  ...
  public static final String POINT_VALIDATION_MESSAGE =
      "coords must be specified as a point with longitude and latitude, i.e. POINT(-89.35 43.0864)";
  public static final String POINT_VALIDATION_REGEX =
      "POINT ?\\(-?[0-9]+((.)[0-9]+)?\\s-?[0-9]+((.)[0-9]+)?\\)";
  ...
  public static final String DISTANCE_VALIDATION_MESSAGE =
      "distance must be between 1 and 9999 kilometers";
  // Validates that distances is either an empty string or a string representing 1 to 9999
  // kilometers
  ...
  public Map<String, Object> processParameters(
      ...
      final String trimTolerance) {
    Map<String, Object> parameterMap =
        processParameters(comid, navigationMode, distance, stopComid);

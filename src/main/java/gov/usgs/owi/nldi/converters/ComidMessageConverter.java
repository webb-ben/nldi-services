...
public class ComidMessageConverter extends AbstractHttpMessageConverter<Comid> {
    ...
    @Override
    protected Comid readInternal(Class<? extends Comid> aClass, HttpInputMessage httpInputMessage) throws IOException, HttpMessageNotReadableException {
        return null;
    }

    @Override
    protected void writeInternal(Comid comid, HttpOutputMessage httpOutputMessage) throws IOException, HttpMessageNotWritableException {

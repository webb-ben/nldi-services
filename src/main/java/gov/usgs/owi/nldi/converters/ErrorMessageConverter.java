...
public class ErrorMessageConverter extends AbstractHttpMessageConverter<Error> {
    ...
    @Override
    protected Error readInternal(Class<? extends Error> aClass, HttpInputMessage httpInputMessage) throws IOException, HttpMessageNotReadableException {
        return null;
    }

    @Override
    protected void writeInternal(Error error, HttpOutputMessage httpOutputMessage) throws IOException, HttpMessageNotWritableException {

...
public class FeatureMessageConverter extends AbstractHttpMessageConverter<Feature> {
    ...
    @Override
    protected Feature readInternal(Class<? extends Feature> aClass, HttpInputMessage httpInputMessage) throws IOException, HttpMessageNotReadableException {
        return null;
    }

    @Override
    protected void writeInternal(Feature feature, HttpOutputMessage httpOutputMessage) throws IOException, HttpMessageNotWritableException {
    ...
    private void writeJsonLd(Feature feature, HttpOutputMessage httpOutputMessage) throws IOException {
        ...
        try (JsonGenerator generator = builder.build().createGenerator(outputStreamWriter)) {
            ...
            generator.writeStringField("@type", "https://www.opengis.net/def/schema/hy_features/hyf/HY_HydroLocation");
            ...
            generator.writeStringField("comid", "https://geoconnex.us/nhdplusv2/comid/" + feature.getComid());
            ...
            if (feature.getMeasure() != null && feature.getReachcode() != null) {
                ...
                generator.writeStringField("hyf:linearElement", "https://geoconnex.us/nhdplusv2/reachcode/" + feature.getReachcode());
            ...
            generator.writeStringField("@type", "http://www.opengis.net/ont/sf#" + feature.getGeometry().getType());
    ...
    private void writeGeoJson(Feature feature, HttpOutputMessage httpOutputMessage) throws IOException {
